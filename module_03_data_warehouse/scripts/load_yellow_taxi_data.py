...
BUCKET_NAME = "zoomcamp-airflow-486119-hw3-yellow-2024"
PROJECT_ID = "zoomcamp-airflow-486119"
...
def download_file(month, retries=3, timeout=60):
    ...
    for attempt in range(1, retries + 1):
        try:
            ...
            with urllib.request.urlopen(url, timeout=timeout) as r, open(file_path, "wb") as f:
                f.write(r.read())
...
def upload_to_gcs(file_path, max_retries=3):
    blob_name = f"yellow/2024/{os.path.basename(file_path)}"
